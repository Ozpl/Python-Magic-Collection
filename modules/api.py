...
def get_data_from_scryfall():
    ...
    time_difference = (datetime.now() - datetime.strptime(SETTINGS_JSON['bulk_last_updated'], SETTINGS_JSON['time_format'])).total_seconds()
    ...
    if time_difference > SETTINGS_JSON['bulk_time_period']:
        ...
        with open(SETTINGS_FILE_PATH, 'w', encoding='utf8') as f:
            ...
            file_content['bulk_last_updated'] = str(datetime.now().strftime(SETTINGS_JSON['time_format']))
